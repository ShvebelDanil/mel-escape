...
function buildDecorUnit(kind) {
  ...
  else if (kind === 'board') { put(g, box(2.9, 1.55, 0.08, '#5d4634'), 0, 2.35, 0.04); put(g, box(2.7, 1.35, 0.03, '#1f3029'), 0, 2.35, 0.085); picMesh(g, 'board', 2.7, 1.35, 0, 2.35, 0.105); put(g, box(2.8, 0.07, 0.14, '#5d4634'), 0, 1.55, 0.1); }
