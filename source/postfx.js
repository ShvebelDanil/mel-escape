...
//   2) ТОЛЬКО светящиеся объекты (слой BLOOM_LAYER: лампы, окна, пузырики, ореолы паверапов, искры) →
...
const BLOOM_THRESH = 0.7;    // ниже этой яркости светящийся объект не светится
