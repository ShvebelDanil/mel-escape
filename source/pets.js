...
export const PETS = [
  ...
  { id: 'rabbitBurmaldaets', nameKey: 'pet.rabbitBurmaldaets.name', price: 3000, descKey: 'pet.rabbitBurmaldaets.desc', build: petRabbitBurmaldaets },
  { id: 'catost', nameKey: 'pet.catost.name', price: 10000, descKey: 'pet.catost.desc', build: petCatost }
];
