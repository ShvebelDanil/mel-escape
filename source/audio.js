...
const SFX = {
  ...
  coin:      { gain: 0.08, pitch: 0.05 },  // сбор пузырика на бегу
  book:      { gain: 0.10, pitch: 0.02 },  // интро: Мэл хватает дневник со стола
  purchase:  { gain: 0.15, pitch: 0.03 },  // успешная покупка скина/питомца в магазине
  ...
  ui_denied: { gain: 0.10, pitch: 0.05 }      // в магазине не хватает пузыриков
};
